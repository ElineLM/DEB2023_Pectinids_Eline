...
estim_options('max_fun_evals', 10e3); %changed from 5e3 to 10e3 (from AmP)

estim_options('pars_init_method', 2); %2 to start from pars_init file, and 1 to start from result mat file
estim_options('results_output', 3); %3 to save %0 apparently to save only in .mat and to do continuation 
